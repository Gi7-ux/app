...
if ($jwt) {
    try {
        ...
        if (!empty($data->id)) {
            ...
            echo json_encode(array("message" => "Unable to update project. ID is missing."));
        }
    } catch (Exception $e) {
